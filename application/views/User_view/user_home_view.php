...
<form action="<?php echo base_url('index.php/User_controller/User_home_controller/manage_user_side/add'); ?>" method="post" style="border:1px solid #ccc">
  <div class="container">
    <label><b>User Name</b></label>
    <input type="text" id="txt_user_name" name="txt_user_name" placeholder="Enter User Name" name="email"
    required>

    <label><b>User Adhar Number</b></label>
    <input type="text" id="txt_user_aadhar_number" name="txt_user_aadhar_number" placeholder="Enter User addhar number"
    ...
    <input type="text" id="txt_user_phone_number"  name="txt_user_phone_number" placeholder="Phone number" required>
